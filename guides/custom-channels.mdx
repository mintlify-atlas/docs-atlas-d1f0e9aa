...
- [Architecture](/architecture) - Channel layer design
- [API Reference](/api/channel) - Full trait documentation
- [CLI Channel](/api/channels/cli) - Built-in CLI channel reference
